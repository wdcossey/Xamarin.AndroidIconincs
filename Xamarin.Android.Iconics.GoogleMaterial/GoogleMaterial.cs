...
{
  public class GoogleMaterial : ITypeface
  {
    private const string TTF_FILE = "google_material_design.ttf";
    ...
    {
      return new GoogleMaterialIcon((Icon) Enum.Parse(typeof (Icon), key, true));
    }
    ...
    {
      get { return "Google Material Design"; }
    }
    ...
    {
      get { return "Attribution 4.0 International"; }
    }

    public string LicenseUrl
    {
      get { return "http://creativecommons.org/licenses/by/4.0/"; }
    }
    ...
    private class GoogleMaterialIcon : IIcon
    {
      private readonly Icon _icon;

      protected internal GoogleMaterialIcon(Icon icon)
      {
        _icon = icon;
      }
      ...
      {
        get { return _iconTypeface ?? (_iconTypeface = new GoogleMaterial()); }
      }
    }
  }
}