...
namespace com.xamarin.AndroidIconics.Typefaces
{
  ...
  /// </summary>
  public class FontAwesome : ITypeface
  {
    private const string TTF_FILE = "fontawesome-webfont-4.3.0.ttf";
    ...
    {
      return new FontAwesomeIcon((Icon) Enum.Parse(typeof (Icon), key, true));
    }
    ...
    {
      get { return "Dave Gandy"; }
    }

    public string Url
    {
      get { return "https://github.com/FortAwesome/Font-Awesome"; }
    }
    ...
    public string Description
    {
      ...
      {
        return
          "Font Awesome is a full suite of 479 pictographic icons for easy scalable vector graphics on websites, created and maintained by Dave Gandy. Stay up to date @fontawesome.";
      }
    }
    ...
    public class FontAwesomeIcon : IIcon
    {
      private readonly Icon _icon;

      protected internal FontAwesomeIcon(Icon icon)
      {
        _icon = icon;
      }

      public static FontAwesomeIcon GetIcon(Icon icon)
      {
      ...
      {
        get { return _iconTypeface ?? (_iconTypeface = new FontAwesome()); }
      }
    }
